...
export const navOrder: NavEntry[] = [
  ...
  { label: "Popover & Dialog", to: "/decorators/overlay", section: "Decorators", icon: "layers" },
  { label: "Portal", to: "/decorators/portal", section: "Decorators", icon: "external-link" },
  { label: "View Transitions", to: "/decorators/view-transition", section: "Decorators", icon: "sparkles" },
  { label: "Animate", to: "/decorators/animate", section: "Decorators", icon: "activity" },
  ...
  { label: "Selection & Highlights", to: "/decorators/selection", section: "Decorators", icon: "type" },
  { label: "Element Internals", to: "/decorators/internals", section: "Decorators", icon: "puzzle" },
  { label: "Permission", to: "/decorators/permission", section: "Decorators", icon: "shield-check" },
  { label: "Media", to: "/decorators/media", section: "Decorators", icon: "monitor" },
  { label: "Visibility & Network", to: "/decorators/environment", section: "Decorators", icon: "radio" },
  { label: "Fullscreen", to: "/decorators/fullscreen", section: "Decorators", icon: "maximize" },
  { label: "Device APIs", to: "/decorators/device", section: "Decorators", icon: "cpu" },
  { label: "SSE & WebSocket", to: "/decorators/streams", section: "Decorators", icon: "plug" },
