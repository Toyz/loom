...
LoomIcon.registerAll({
  ...
  // Misc
  "radio": '<path d="M16.85 18.58a9 9 0 1 0-9.7 0" /><path d="M8 14a5 5 0 1 1 8 0" /><circle cx="12" cy="17" r="1" fill="currentColor" stroke="none" />',
  "columns": '<path d="M12 3h7a2 2 0 0 1 2 2v14a2 2 0 0 1-2 2h-7m0-18H5a2 2 0 0 0-2 2v14a2 2 0 0 0 2 2h7m0-18v18" />',
  "puzzle": '<path d="M19.439 7.85c-.049.322.059.648.289.878l1.568 1.568c.47.47.706 1.087.706 1.704s-.235 1.233-.706 1.704l-1.611 1.611a.98.98 0 0 1-.837.276c-.47-.07-.802-.452-.968-.908a2.5 2.5 0 0 0-4.76 1.067 2.5 2.5 0 0 0 2.5 2.5c.462 0 .898-.125 1.27-.345.39-.231.864-.138 1.176.174l1.568 1.568c.47.47.706 1.087.706 1.704s-.236 1.234-.706 1.704L16.97 24.54c-.47.47-1.087.706-1.703.706s-1.234-.236-1.704-.706l-1.568-1.568a.985.985 0 0 1-.276-.837c.07-.47.452-.802.908-.968a2.5 2.5 0 0 0 1.067-4.76 2.5 2.5 0 0 0-2.5 2.5" /><path d="M9 6a3 3 0 1 0 0 6 3 3 0 0 0 0-6z" /><path d="M2 12h4m12 0h4M12 2v4m0 12v4" />',
