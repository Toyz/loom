...
@searchable({ title: "Lifecycle", section: "Element", icon: "refresh", to: "/element/lifecycle", keywords: ["lifecycle", "mount", "unmount", "connected", "disconnected", "connectedCallback"], summary: "Hooks for setup, teardown, error handling, and async loading." })
