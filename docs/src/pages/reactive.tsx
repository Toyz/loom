/**
 * Reactive State — /core/reactive
 */
import { LoomElement, component } from "@toyz/loom";
import { route } from "@toyz/loom/router";

@route("/core/reactive")
@component("page-reactive")
export class PageReactive extends LoomElement {
  update() {
    return (
      <div>
        ...
        <section>
          ...
          <code-block lang="ts" code={`import { Reactive, LocalMedium } from "@toyz/loom";
  ...
  storage: new LocalMedium(),
          ...
          <table class="api-table">
            ...
            <tbody>
              ...
              <tr><td><code>.set(next)</code></td><td>Set a new value or pass an updater function <code>(prev) =&gt; next</code></td></tr>
...
todos.subscribe((items) => {
  console.log(\`\${items.length} todos\`);
        ...
        <section>
          ...
          <p>
            Use <span class="ic">@mount</span> to subscribe a component to reactive state changes:
          </p>
          <code-block lang="ts" code={`@component("todo-list")
